...
Interfaz.prototype.mostrarMensaje = function(mensaje, tipo) {
     ...
     //necesita el elemento que se va a insetar y despues de cual
     formulario.insertBefore(div, document.querySelector('.form-group'));
     //para que el mensaje desaparesca
     setTimeout(function() {
...
formulario.addEventListener('submit', function(e) {
     ...
     //retorna el valor seleccionado del option
     const marcaSeleccioanda = marca.options[marca.selectedIndex].value;

     // leer el año seleccionado del <select>
     const anio = document.getElementById('anio');
     //anio.options --> devuelve una lista con las opciones dentro del select en formato html
     //anio.selectedIndex --> devuelve el indice de la opcion seleccionada
...
// llena todo el select con los años disponibles
